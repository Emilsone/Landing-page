    ...
    <div class="container-logo" >
        ...
        <div class="p-4 lg:w-2/5">
          ...
          >
            ...
            >
              Payme Design System okon go school
            </h1>
            <p class="leading-relaxed mb-3">
              MyCustomer is an on-demand, scalable ledger solution for small and
            ...
            <div
              class=" mt-24 flex   "
            >
              <img src="../assets/holding-iphone.png" alt=" love logo" class="ml-auto image-phone" id="image-phone"/>
            </div>
          </div>
        </div>
        <div class="p-4 lg:w-2/5">
      ...
      >
        ...
        <div class="p-4 lg:w-2/5">
          <div
            class="h-auto bg-gray-200 px-8 pt-16 pb-24 py-48 overflow-hidden  card-two"
          >
            <h1
              class="title-font sm:text-2xl  text-xl font-medium text-gray-900 mb-3"
            >
